...
def build_ml_dataset() -> None:
    ...
    # Rename VIX date column to trading_date for merge
    vix_merge = vix.rename(columns={"date": "trading_date"})
    ...
    print(df[["trading_date", "vix_level", "vix_30d_mean", "vix_regime"]].head())
